...
?>
  ...
  <!--                         <div class="form-group">
                        ...
                        <div class="form-group">
                          <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Pickup Date & time
                          </label>
                         ...
                         <div class="form-group">
                          <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Return Date & time
                          </label>
                        ...
                        <div class="form-group">
                          <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Driver
                          </label>
                          <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    <optgroup label="Eastern Time Zone">
                      ...
                      <option value="WV">West Virginia</option>
                        ...
                        <div class="form-group">
                          <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Delivery Term
                          </label>
                          <div class="col-md-6 col-sm-6 col-xs-12">
      ...
      //                      $sqlb = "SELECT * FROM booking_trans WHERE (return_date <= '" . conv_datetodbdate($search_return_date).' '.$search_return_time.':00'."' AND return_date >= 
      //                      '" . conv_datetodbdate($search_pickup_date).' '.$search_pickup_time.':00'."') 
      //                      OR (pickup_date >= '" . conv_datetodbdate($search_pickup_date).' '.$search_pickup_time.':00'."' AND pickup_date <= '" . conv_datetodbdate($search_return_date).' '.$search_return_time.':00'."')  
      //                      group by vehicle_id";
      ...
      //                      $sqlc = "SELECT * FROM extend WHERE (extend_to_date   <= '" . conv_datetodbdate($search_return_date).' '.$search_return_time.':00'."' AND extend_to_date  >= 
      //                        '" . conv_datetodbdate($search_pickup_date).' '.$search_pickup_time.':00'."') 
      //                        OR (extend_from_date  >= '" . conv_datetodbdate($search_pickup_date).' '.$search_pickup_time.':00'."' AND extend_from_date  <= '" . conv_datetodbdate($search_return_date).' '.$search_return_time.':00'."')  
      //                        group by vehicle_id";  


      // // echo conv_datetodbdate($search_return_date).' '.$search_return_time.':00';
      ...
      //                        db_select($sql);
                          ...
                          echo "
                            <tr>
                            <td colspan='10' style='text-align:center'>"; func_getPaging('counter_reservation.php?x&btn_search=&search_pickup_date=' . $search_pickup_date . '&search_pickup_time=' . $search_pickup_time . '&search_return_date=' . $search_return_date . '&search_return_time=' . $search_return_time . '&search_pickup_location=' . $search_pickup_location . '&search_return_location=' . $search_return_location); echo "</td> </tr>"; 
                        }
                        else{

                          echo "<script> alert('NOTE: if there is no activity in this section for 30 minutes, a refresh will be made to avoid technical issues, TQ.'); </script>";
