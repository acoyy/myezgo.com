...
model,
refund_dep,
DATE_FORMAT(pickup_date, '%m/%d/%Y %H:%i:%s') as pickup_date,
DATE_FORMAT(return_date, '%m/%d/%Y %H:%i:%s') as return_date,
sub_total,
est_total,
balance,
discount_coupon,
...
$pdf->AddPage(); 
$pdf->setSourceFile('document/bookingreceipt.pdf'); 
$tplIdx = $pdf->importPage(1); 
$pdf->useTemplate($tplIdx); 
$pdf->SetFont('Helvetica', '', 10); 
$pdf->SetTextColor(0, 0, 0); 

$pdf->Image('img/'.$company_image, 6.7, 12.6, 16); 

$pdf->SetXY(25, 15); 

$pdf->Write(0, $company_name);

$pdf->Image('img/'.$company_image, 6.7, 163, 16); 
