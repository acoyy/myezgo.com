...
// 		echo "<br>day_agent: ".$day_agent;
	...
	if(isset($btn_save_booking)){
		...
		else
		{
			...
			vali_redirect("mail_booking.php?booking_id=" . $booking_id); 
		}
	}
											...
											<div class="x_content">
												...
												<div id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
													...
													<div class="form-group">
														...
														<div class="col-md-6 col-sm-6 col-xs-12">
															<input id="huhu3" type="text" class="form-control" placeholder="NRIC No" name="nric_no" id="nric_no" value="<?php echo $nric_no; ?>" onblur="selectNRIC(this.value)" disabled>
														</div>
													</div>
													...
													<div class="form-group">
														...
														<div class="col-md-6 col-sm-6 col-xs-12">
															<input type="date" class="form-control" placeholder="License Expired" id="license_exp" name="license_exp" value="<?php echo $license_exp; ?>" required>
														</div>
													</div>
											...
											<div class="x_content">
												...
												<div id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
													...
													<div class="form-group">
														...
														<div class="col-md-6 col-sm-6 col-xs-12">
															<input type="text" class="form-control" placeholder="Last Name" name="lastname" id="lastname_booking" value="<?php echo $lastname; ?>" id="lastname" required>
														</div>
													</div>
