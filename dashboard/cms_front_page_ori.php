...
?>
    ...
    if (isset($_FILES['productthree_img'])) { 
        ...
        $car1_query=mysql_query($sqlCar1);//run sql
        $rowCar1=mysql_fetch_array($car1_query);//capture one record

        $sqlCar2="SELECT * FROM display WHERE id='2'";
        $car2_query=mysql_query($sqlCar2);//run sql
        $rowCar2=mysql_fetch_array($car2_query);//capture one record

        $sqlCar3="SELECT * FROM display WHERE id='3'";
        $car3_query=mysql_query($sqlCar3);//run sql
        $rowCar3=mysql_fetch_array($car3_query);//capture one record

        $sqlCar4="SELECT * FROM display WHERE id='4'";
        $car4_query=mysql_query($sqlCar4);//run sql
        $rowCar4=mysql_fetch_array($car4_query);//capture one record


        $sqlCar5="SELECT * FROM display WHERE id='5'";
        $car5_query=mysql_query($sqlCar5);//run sql
        $rowCar5=mysql_fetch_array($car5_query);//capture one record

        $sqlCar6="SELECT * FROM display WHERE id='6'";
        $car6_query=mysql_query($sqlCar6);//run sql
        $rowCar6=mysql_fetch_array($car6_query);//capture one record

        $sqlCar7="SELECT * FROM display WHERE id='7'";
        $car7_query=mysql_query($sqlCar7);//run sql
        $rowCar7=mysql_fetch_array($car7_query);//capture one record

        $sqlCar8="SELECT * FROM display WHERE id='8'";
        $car8_query=mysql_query($sqlCar8);//run sql
        $rowCar8=mysql_fetch_array($car8_query);//capture one record

        $sqlCar9="SELECT * FROM display WHERE id='9'";
        $car9_query=mysql_query($sqlCar9);//run sql
        $rowCar9=mysql_fetch_array($car9_query);//capture one record
