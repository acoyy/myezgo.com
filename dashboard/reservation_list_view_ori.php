  ...
  if (db_rowcount() > 0) { 
    ...
    if(isset($_POST['btn_change_cust'])){
      ...
      if (db_rowcount() > 0) { 
        ...
        $sql = "UPDATE customer SET title = '$title', firstname = '$firstname', lastname= '$lastname', license_no = '$license_no', license_exp = '$license_exp', age = '$age', phone_no = '$phone_no', phone_no2 = '$phone_no2', email = '$email', address = '$address', postcode = '$postcode', city = '$city', country = '$country', ref_name = '$ref_name', ref_phoneno = '$ref_phoneno', ref_relationship = '$ref_address', drv_name = '$drv_name', drv_nric = '$drv_nric', drv_address = '$drv_address', drv_phoneno = '$drv_phoneno', drv_license_no = '$drv_license_no', drv_license_exp = '$drv_license_exp', survey_type = '$survey_type', mid = '".$_SESSION['cid']."', mdate = '".date('Y-m-d H:i:s',time())."' WHERE nric_no = '$nric_no'"; 
      ...
      else
      {
        ...
        echo "<script>
          ...
          if (isset($_POST['btn_in'])) {
            ...
            echo "<script>
              window.location.href='mail.php?status=return&booking_id=".$_GET['booking_id']."';
              </script>
            ";
          ...
          if (isset($_POST['btn_out'])) { 
            ...
            if(isset($_FILES['files'])){ 
              ...
              $sql = "SELECT sequence FROM upload_data WHERE vehicle_id =".$vehicle_id . " ORDER BY created DESC LIMIT 1";
              ...
              foreach($_FILES['files']['tmp_name'] as $key => $tmp_name ){ 
                ...
                if(db_rowcount()>0) {
                  ...
                  $sql = "UPDATE upload_data SET booking_trans_id = '$id', file_size = '$file_size', file_type = '$file_type', modified = '".date('Y-m-d H:i:s',time())."', mid = '".$_SESSION['cid']."' WHERE vehicle_id = '$vehicle_id' AND no = '$key' AND sequence = '$sequence'";
                }
                else {

                  $sql = "INSERT INTO upload_data (no, sequence, booking_trans_id, file_name, file_size, file_type, vehicle_id, created, cid) VALUES ('$key','$sequence','$id','$file_name','$file_size','$file_type','$vehicle_id','".date('Y-m-d H:i:s',time())."','".$_SESSION['cid']."') "; 
                }
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="checkbox">
                                      <center>
                                        ...
                                        <label>I (Renter)1 received this car in <b>CLEAN</b> condition without any <b>FORBIDDEN STUFF</b> or <b>CRIMINAL ACTIVITY STUFF.</b></label> 
                    ...
                    <div class="x_content">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td><?php echo date('d/m/Y H:i:s',strtotime($return_date)); ?></td>
                        </tr>
                      </tbody>
