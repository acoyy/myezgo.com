...
// 		echo "<script> alert('masuk if 112'); </script>";
		
// 		if (($day >= $dbpromo_how_many_day_min) && ($date <= $dbpromo_how_many_day_max)) { 

// 			$date = date('m/d/Y', strtotime($_GET['search_return_date'])); 
// 			$newdate = strtotime('+' . $free_day . ' day', strtotime($date)); 
// 			$newdate = date('m/d/Y', $newdate); 
// 			$search_return_dates = $newdate; 
// 			echo '<script language="javascript">'; 
// 			echo 'alert("Free ' . $free_day . ' Day");'; 
// 			echo '</script>';
// 			$freeday = 'true';
// 		} 
	...
	//button SAVE clicked
		...
		if ($answer == "pickup") 
		{
		    ...
		    if (func_isValid()) 
		    {
		    	// echo "<script> alert('masuk valid'); </script>";
			     ...
			     $sql = "INSERT INTO customer
					...
					'" . date('Y-m-d', strtotime($license_exp)) . "',
					" . $age . ",
			...
			else
			{
				...
				echo "<script> alert('Data inserted is incomplete'); </script>";

				vali_redirect("counter_reservation_view.php?vehicle_id=" . $_GET['vehicle_id'] . "&search_pickup_date=" . $_GET['search_pickup_date'] . "&search_pickup_time=" . $_GET['search_pickup_time'] . "&search_return_date=" . $_GET['search_return_date'] . "&search_return_time=" . $_GET['search_return_time'] . "&search_pickup_location=" . $_GET['search_pickup_location'] . "&search_return_location=" . $_GET['search_return_location'] . "&class_id=" . $_GET['class_id'] . "&delivery_cost=" . $_GET['delivery_cost'] . "&p_delivery_address=" . $_GET['p_delivery_address'] . "&r_delivery_address=" . $_GET['r_delivery_address'] . "&pickup_cost=" . $_GET['pickup_cost'] . "&p_pickup_address=" . $_GET['p_pickup_address'] . "&r_pickup_address=" . $_GET['r_pickup_address']);
			}
		...
		else if($answer == "booking")
		{
		    ...
		    if (func_isValid()) {
				...
				if ($_GET['pickup_cost'] >= 1) { 
					...
					// echo "<br>form pickup date: ". date('m/d/Y', strtotime($_GET['search_pickup_date']))." ".$_GET['search_pickup_time'].":00";
					// echo "<br>pickup location: ".$search_pickup_location;
					// echo "<br>pickup time: ".$search_pickup_time;
					// echo "<br>form return date: " .date('m/d/Y', strtotime($search_return_dates))." ".$_GET['search_return_time'].":00";
					// echo "<br>return location: ".$search_return_location;
					// echo "<br>return time: ".$search_return_time;
					// echo "<script>alert('Discount: ".$Discount."'); </script>";
					// echo "<br>vehicle id: ".$_GET['vehicle_id'];
					// echo "<br>Day: ".$day;
					// echo "<br>Subtotal: ".$subtotal;
					// echo "<br>gsthidden: ".$gsthidden;
					// echo "<br>est total: ".$est_total;
					// echo "<br>Cust ID: ".$dbcustomer_id;
					// echo "<br>Car rate:".$dbcar_rate_deposit;
					// echo "<br>pickup cost: ".$_GET['pickup_cost'];
					// echo "<br>form pickup address: ". conv_text_to_dbtext3($_GET['p_pickup_address']);
					// echo "<br>form return address: ". conv_text_to_dbtext3($_GET['r_pickup_address']);
					// echo "<br>Agent: ".$agent;
					// echo "<br>Branch: ".$_SESSION['user_branch'];
					// echo "<br>Payment Details: ".$payment_details;
		...
		$daylog = '0';
		$datelog = date('m/d/Y', strtotime($_GET['search_pickup_date'])).' '.$_GET['search_pickup_time'];

		$hourlog = dateDifference($pickup_date.$pickup_time, date('m/d/Y', strtotime($search_return_dates)).$return_time, '%h');
		$day = dateDifference($pickup_date.$pickup_time, date('m/d/Y', strtotime($search_return_dates)).$return_time, '%a');

		$a = 0;

		while($datelog <= date('m/d/Y', strtotime($search_return_dates)).' '.$_GET['search_return_time'])
		{

			$currdate = date('Y-m-d',strtotime($datelog)).' '.$_GET['search_pickup_time'];
			// echo "<br> return date: ".date('m/d/Y', strtotime($search_return_dates)).' '.$_GET['search_return_time'];
			...
			$week1date1 = date('m/d/Y', strtotime($mymonth.'/01/'.$myyear))." 00:00:00";
		    $week1date2 = date('m/d/Y', strtotime($mymonth.'/07/'.$myyear))." 23:59:59";
		    $week2date1 = date('m/d/Y', strtotime($mymonth.'/08/'.$myyear))." 00:00:00";
		    $week2date2 = date('m/d/Y', strtotime($mymonth.'/14/'.$myyear))." 23:59:59";
		    $week3date1 = date('m/d/Y', strtotime($mymonth.'/15/'.$myyear))." 00:00:00";
		    $week3date2 = date('m/d/Y', strtotime($mymonth.'/21/'.$myyear))." 23:59:59";
		    $week4date1 = date('m/d/Y', strtotime($mymonth.'/22/'.$myyear))." 00:00:00";
		    $week4date2 = date('m/d/Y', strtotime($mymonth.'/28/'.$myyear))." 23:59:59";
		    $week5date1 = date('m/d/Y', strtotime($mymonth.'/29/'.$myyear))." 00:00:00";
		    $week5date2 = date('m/d/Y', strtotime($mymonth.'/31/'.$myyear))." 23:59:59";
			...
			$datelog = date('m/d/Y', strtotime("+1 day", strtotime($datelog)))." ".$_GET['search_pickup_time'];
					...
					<div class="">
						...
						<div class="row">
							<div class="col-md-12 col-sm-12 col-xs-12">
								<div class="x_panel">
									<div class="x_title">
										<h2>Counter Reservation View</h2>
										...
										<div id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
											...
											<div class="form-group">
												...
												<div class="col-md-6 col-sm-6 col-xs-12">
													<input type="text" class="form-control" placeholder="NRIC No" name="nric_no" id="nric_no" value="<?php echo $nric_no; ?>" onblur="selectNRIC(this.value)" required>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-md-6 col-sm-6 col-xs-12">
													<input type="number" class="form-control" placeholder=" Postcode" name="postcode" value="<?php echo $postcode; ?>" id="postcode">
												</div>
											</div>
									...
									<div class="x_content">
										...
										<div id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
											...
											<div class="form-group">
												...
												<div class="col-md-6 col-sm-6 col-xs-12">
													<select name="payment_details" id="payment_details" class="form-control">
														<option value="">Please Select</option>
											...
											<div class="form-group">
												...
												<div class="col-md-6 col-sm-6 col-xs-12">
													<select name="refund_dep_payment" id="refund_dep_payment" class="form-control">
									...
									<div class="x_content">
										...
										<div id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
											<div class="form-group">
												...
												<div class="col-md-6 col-sm-6 col-xs-12">
													<select name="survey_type" id="survey_type" class="form-control" id="survey" onchange="change();">
