   ...
   if(isset($btn_save)){ 
   	...
   	if(func_isValid()){ 
   		...
   		$sql = "INSERT INTO gps
  					...
  					VALUES(
  					'".$vehicle_id."',
  					'".conv_text_to_dbtext3($owner_name)."',
  					'".conv_text_to_dbtext3($nric_no)."',
  					'".conv_text_to_dbtext3($serial_no)."',
  					'".$phone_no."', 
  					".$credit_balance.", 
  					'".conv_datetodbdate($expiry_date)."',
  					'".conv_datetodbdate($sim_expiry_date)."',
  					".$_SESSION['cid'].",
  					CURRENT_TIMESTAMP 		
  					)"; 
                      ...
                      <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                        ...
                        <div class="form-group">
                          <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                            ...
                            <button type="button" class="btn btn-danger" onclick="location.href='fleet_management_gps.php?btn_search=&search_vehicle=<?php echo $search_vehicle;?>'">Cancel</button>
