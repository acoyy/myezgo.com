...
?>
	...
	if(isset($btn_redeem))
	{
		...
		$row_discount = db_rowcount();

		$sql = "SELECT * FROM agent WHERE code='$agent'";

		db_select($sql);

		$row_agent = db_rowcount();
		...
		if ($row_discount > 0) 
		{
			...
			$sql = "SELECT id AS agent_id, name AS agent_name FROM agent WHERE code='$agent'";
	...
	if(isset($_POST['btn_extend'])) { 
		...
		if(db_rowcount() < 9){ 
			...
			if($agent_profit != '' || $agent_profit != NULL){ 
				$extra = ' (Agent)'; 
	                        			...
	                        			<form id="demo-form1" name="demo-form1" data-parsley-validate class="form-horizontal form-label-left" method="POST">
	                        				<div class="container">
												...
												<div class="">
													...
													<div class='col-sm-4'>
														...
														<div class="form-group">
															<div class='input-group date col-md-12 col-sm-6 col-xs-12' >
																<input type="text" class="form-control" name="coupon" value="<?php echo $coupon; ?>" id="coupon" oninput="myFunction()" <?php if($row_agent > 0) echo 'disabled'; ?>>
															</div>
														</div>
													</div>
													<div class='col-sm-4'>
														...
														<div class="form-group">
															<div class='input-group date col-md-12 col-sm-6 col-xs-12' >
																<input type="text" class="form-control" name="agent" id="agent" oninput="myFunction2()" value="<?php echo $agent; ?>" <?php if($row_discount > 0) echo 'disabled'; ?>>
															</div>
														</div>
													</div>
													<script>
							                            $("#coupon").blur(function() {
							                            	if(document.getElementById("coupon").value == '') {
							                            		document.getElementById("agent").removeAttribute("disabled");
							                                }
							                        ...
							                        <script>
							                            function myFunction() {
							                            	...
							                            	document.getElementById("agent").setAttribute("disabled", "");
							                            }
							                        ...
							                        <?php
							                        	...
							                        	if($row_agent > 0)
							                        	{
								                            ...
								                            $agent_query = "&agent_id=".$agent_id."&agent=".$agent;
											...
											<div class="form-group" style="text-align: center;">
												<div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
													...
													<?php if($row_agent > 0){ ?> <input type="hidden" name="agent_id" value="<?php echo $agent_id; ?>"> <?php } ?>
											...
											<div class="form-group" style="text-align: center;">
												<div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
													...
													<?php if($row_agent > 0){ ?> 	
														...
														<input type="hidden" name="agent_profit" value="<?php echo $agent_profit; ?>">
													<?php } ?>
