                    ...
                    <table class="table table-hover">
                      ...
                      <?php
                       ...
                       $sql = "SELECT 
                              ...
                              WHERE fleet_accident.id is not NULL " .$where;
                          ...
                          <td>" . db_get($i, 5) . "</td>
                          <td>
                          <a class='fancybox' href='#".db_get($i,7)."'><i class='icon-magnifier'></i></a>
                          </td>
                          <td><a href='fleet_management_accident_edit.php?id=".db_get($i,7)."&search_vehicle=".$search_vehicle."'><i class='fa fa-pencil'></i></a>
                          &nbsp;&nbsp; 
