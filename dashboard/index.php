...
{ 
    ...
    if(isset($_GET['list'])) {
        ...
        vali_redirect("reservation_list_view?booking_id=".$_GET['list']);
    } else {
...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <link href="assets/css/core/now-ui-kit.css" rel="stylesheet" />
</head>
    ...
    <nav class="navbar navbar-expand-lg bg-primary fixed-top navbar-transparent " color-on-scroll="400">
        <div class="container">
            ...
            <div class="navbar-translate">
                <a class="navbar-brand" href="../" rel="tooltip" title="Designed by &amp; Coded by D.Danial Zurkanain" data-placement="bottom">
    ...
    <div class="page-header" filter-color="primary">
        ...
        <footer class="footer">
            <div class="container">
                ...
                <div class="copyright">
                    <!-- made by acoyy n programmers from Myezgo Travel & Tours
                        nashrulamir79@gmail.com
                        0142738256 - Amir/Acoyy
                        Malaysia
                        -->
                    &copy;
                    <script>
