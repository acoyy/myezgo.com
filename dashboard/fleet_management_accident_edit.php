                    ...
                    <div class="x_content">
                      ...
                      <form method="post" enctype = "multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" class="form-control" id="single_cal1" placeholder="start_date" aria-describedby="inputSuccess2Status" name="accident_date" value="<?php echo $accident_date;?>" autocomplete="off">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" class="form-control" id="single_cal2" placeholder="Pickup Date" aria-describedby="inputSuccess2Status" name="closed_date" value="<?php echo $closed_date;?>" autocomplete="off">
