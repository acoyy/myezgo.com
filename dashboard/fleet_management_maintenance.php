                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <select class="form-control" name="search_vehicle" <?php echo $disabled;?>>
                              ...
                              $value = $value."<option value='".db_get($j,0)."' ".vali_iif(db_get($j,0)==$search_vehicle,'Selected','').">".db_get($j,1)." : ".db_get($j,2). " (" .db_get($j,3). ")</option>"; 
                  ...
                  <div class="x_panel">
                    ...
                    <table class="table table-hover">
                      ...
                      <?php
                       ...
                       $sql = "SELECT 
  							fleet_maintenance.id, 
  							reg_no,
  							model, 
  							year, 
  							fleet_maintenance.description, 
  							CASE status WHEN 'O' Then 'Open' WHEN 'C' Then 'Close' end as status,
  							cost
  							FROM fleet_maintenance 
  							LEFT JOIN vehicle ON vehicle.id = vehicle_id 
  							WHERE fleet_maintenance.id is not NULL " .$where;
                          ...
                          <td>" . db_get($i, 6) . "</td>
                          <td>" . db_get($i, 5) . "</td>
                            <td><a href='fleet_management_maintenance_edit.php?id=".db_get($i,0)."&search_vehicle=".$search_vehicle."'><i class='fa fa-pencil'></i></a>
                          &nbsp;&nbsp; 

  <a href='delete_maintenance.php?id=".db_get($i,0)."' onClick='return confirm(\"Delete this?\")'><i class='fa fa-trash'></i></a></td>
                          ...
                          <tr>
                              <td colspan="8" align="center">
                                  <div class="form-group">
                                      <button type="button" class="btn btn-info" name="btn_save" onclick="location.href='fleet_management_maintenance_new.php?btn_search=&search_vehicle=<?php echo $search_vehicle;?>&page=<?php echo $page;?>'">Add New</button>
                                  </div>
                              </td>
                          </tr>
