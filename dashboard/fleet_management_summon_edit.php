                    ...
                    <div class="x_content">
                      ...
                      <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"  method="POST">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <input class="form-control" name="phone_no" id="phone_no" value="<?php echo $phone_no;?>">
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" class="form-control" id="single_cal1" placeholder="date" aria-describedby="inputSuccess2Status" name="date" value="<?php echo conv_datetodbdate3($date);?>" autocomplete="off">
