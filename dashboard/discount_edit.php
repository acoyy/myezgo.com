...
{ 
  ...
  if(isset($btn_save)){ 
  	...
  	$sql = "SELECT id, code, DATE_FORMAT(start_date, '%d/%m/%Y') as start_date, DATE_FORMAT(end_date, '%d/%m/%Y') as end_date, value_in, rate FROM discount WHERE id=".$_GET['id']; 
                    ...
                    <div class="x_content">
  					...
  					<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-2 col-sm-6 col-xs-12">
                            <input type="text" class="form-control" id="single_cal2" placeholder="Pickup Date" aria-describedby="inputSuccess2Status" name="end_date" value="<?php echo $end_date;?>" autocomplete="off">
