...
<style>
  ...
  <div class="row">
                ...
                $extend_from_date = $_GET['extend_from_date']. " " . $_GET['extend_from_time']. ":00";
                $extend_to_date = $_GET['extend_to_date']. " " . $_GET['extend_to_time']. ":00";
                // echo "<br>extend_id: ".$extend_id;
                ...
                $sql = "SELECT 
                  ...
                  extend_to_date,
                  total,
                  sale.payment_status AS payment_status,
                  sale.payment_type AS payment_type,
                  extend.payment AS payment
                  FROM extend
                  JOIN booking_trans ON booking_trans.id = extend.booking_trans_id
                  JOIN sale ON sale.booking_trans_id = booking_trans.id
                  WHERE extend.id = '$extend_id' AND sale.booking_trans_id = '$booking_id' AND sale.type = 'Extend' AND sale.pickup_date = '$extend_from_date' AND sale.return_date = '$extend_to_date'
                ";
                        ...
                        <form id="demo-form2" action="" method="POST" data-parsley-validate class="form-horizontal form-label-left">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              ...
                              <input type='hidden' name='sale_extend_from_date' id='sale_extend_from_date' value='<?php echo $extend_from_date; ?>' disabled>
                              <input type='hidden' name='sale_extend_to_date' id='sale_extend_to_date' value='<?php echo $extend_to_date; ?>' disabled>
                              <label class='switch'>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="number" step='0.01' class="form-control" name="payment_extend" value="<?php echo number_format($payment,2); ?>" id="payment_extend" disabled>
                            </div>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <select name="payment_type" id="payment_type" class="form-control" disabled>
                                <option value="">Please Select</option>
                                <option <?php echo vali_iif('Cash' == $payment_type, 'Selected', ''); ?> value='Cash'>Cash</option>
                                <option <?php echo vali_iif('Online' == $payment_type, 'Selected', ''); ?> value='Online'>Online</option>
                                <option <?php echo vali_iif('Card' == $payment_type, 'Selected', ''); ?> value='Card'>Card</option>
                              </select>
                            </div>
                          </div>
                          <br>
                          ...
                          <script>
                            ...
                            document.getElementById('sale_toggle').onchange = function() {
                                ...
                                document.getElementById('payment_type').disabled = !this.checked;
                                document.getElementById('sale_edit').disabled = !this.checked;
                                document.getElementById('sale_extend_to_date').disabled = !this.checked;
                                document.getElementById('sale_extend_from_date').disabled = !this.checked;
                            };
                          </script>
