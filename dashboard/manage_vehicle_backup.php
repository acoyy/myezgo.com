          ...
          <div class="right_col" role="main">
            ...
            <div class="page-title">
                    ...
                    <div class="x_content">
                      ...
                      <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                       ...
                       <div class="form-group">
                          <label class="control-label col-md-3 col-sm-3 col-xs-12" for="search_classes">Class Name
                          </label>
  			...
  			WHERE vehicle.id IS NOT NULL" . $where; 
  						...
  						<td>".db_get($i,6)."</td>
  						<td>".db_get($i,7)."</td>
                          <td><a href='manage_vehicle_edit.php?id=".db_get($i,0)."&search_vehicle=".$search_vehicle."'><i class='fa fa-pencil'></i></a>
                          &nbsp;&nbsp; 

  <a href='delete_vehicle.php?id=".db_get($i,0)."' onClick='return confirm(\"Delete this?\")'><i class='fa fa-trash'></i></a></td>
                          ...
                          <tr>
                              <td colspan="8" align="center">
                                  <div class="form-group">
                                      <button type="button" class="btn btn-info" name="btn_save" onclick="location.href='manage_vehicle_new.php?btn_search=&search_vehicle=<?php echo $search_vehicle;?>&page=<?php echo $page;?>'">Add New</button>
                                  </div>
                              </td>
                          </tr>
                          ...
                          <tr>
                              <td colspan="8" style="text-align:center">
                                  <?php  func_getPaging('manage_vehicle.php?x&search_vehicle='.$search_vehicle); ?>
                              </td>
                          </tr>
