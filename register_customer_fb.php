...
if( !empty($_SESSION['userData']['id']) ){
  ...
  $providerID = $_SESSION['userData']['id'];
  ...
  echo "<script> alert('Facebook ID is not found!'); </script>";
...
if( !empty($_SESSION['userData']['first_name']) ){

$firstnameFb = $_SESSION['userData']['first_name'];

}


if( !empty($_SESSION['userData']['last_name']) ){

$lastnameFb = $_SESSION['userData']['last_name'];

}

if( !empty($_SESSION['userData']['email']) ){

$emailFb = $_SESSION['userData']['email'];
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input type="email" class="form-control" style="color: gray; font-weight: bold;" name="email" id="email" value="<?php echo $emailFb; ?>" required readonly>
                      ...
                      <input type="email" class="form-control" style="color: gray; font-weight: bold;" name="email" id="email" value="<?php echo $emailFb; ?>" required>
